...
/* ─── Spotify API Integration ───
   Server-only utility that fetches the currently playing
   or last played track using the refresh token flow.
   ─────────────────────────────── */
...
export interface SpotifyTrack {
    ...
    url: string;
    isLive: boolean;
    playedAt?: string; // relative time, e.g. "2hrs ago"
}
...
/** Fetch the currently playing or last played track. */
